...
router.register(
    "collection-requests",
    CollectionRequestViewSet,
    basename="collection-request",
)
router.register(
    "volunteer-profiles",
    VolunteerProfileViewSet,
    basename="volunteer-profile",
)
router.register(
    "pickup-assignments",
    PickupAssignmentViewSet,
    basename="pickup-assignment",
)
router.register(
    "handover-batches",
    HandoverBatchViewSet,
    basename="handover-batch",
)
router.register(
    "route-plans",
    RoutePlanViewSet,
