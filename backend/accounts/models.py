...
class UserManager(BaseUserManager):
    ...
    def _create_user(
        ...
        **extra_fields,
        ...
        if (
            ...
            raise ValueError(
                "Email is required for non-resident accounts."
            )
        ...
        if (
            ...
            raise ValueError(
                "Residents without an email address "
    ...
    def create_superuser(
        ...
        **extra_fields,
        ...
        if not email:
            raise ValueError(
                "Superusers require an email address."
            )
...
class User(
    ...
    def clean(self):
        ...
        if self.email:
            self.email = (
                self.__class__.objects.normalize_email(
                    self.email.strip()
                )
            )
        ...
        if (
            ...
            raise ValidationError(
                {
                    "phone_number": (
                        "Residents without an email "
                        "address must provide a "
                        "phone number."
                    )
                }
            )
        ...
        **kwargs,
        ...
        if self.pk:
            ...
            if (
                ...
                and previous.role
                in PROTECTED_GOVERNANCE_ROLES
                and not allow_governance_update
            ):
                if (
                    previous.email != self.email
                    or previous.role != self.role
                    or previous.is_active
                    != self.is_active
                ):
                    raise ValidationError(
                        "Reserved governance identity "
                        "email, role, and active status "
    ...
    def delete(
        ...
        **kwargs,
        ...
        if (
            ...
            raise ValidationError(
                "Reserved governance identities "
                "cannot be deleted."
            )
